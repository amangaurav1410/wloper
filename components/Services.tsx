                ...
                <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-24">
                    <div className="max-w-2xl text-left">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-wl-accent">Our Capabilities</span>
                        </motion.div>
                        <motion.h2
                    ...
                    <motion.p
                        ...
                        className="text-lg text-wl-muted-dark max-w-sm mb-2 text-left"
                    >
